...
print(pathlist)
path1 = 'E:\FaceAttendance-main\FaceAttendance-main\Training_images'
...
def markAttendance(Enrol):
    with open('E:\FaceAttendance-main\FaceAttendance-main\Attendance.csv', 'r+') as f:
    ...
    while True:
        ...
        for encodeFace, faceLoc in zip(encodesCurFrame, facesCurFrame):
            ...
            if counter!=0:
                ...
                nameFile = open('E:\FaceAttendance-main\FaceAttendance-main\Attendance.csv', 'r+')
